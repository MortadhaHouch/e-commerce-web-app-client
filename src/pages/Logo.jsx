...
export default function Logo(props) {
    return (
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={50} height={50} x="0px" y="0px"
                viewBox="0 0 500 500" xmlSpace="preserve">
            <g id="BACKGROUND">
                <rect id="XMLID_232_" style={{fill:'transparent'}} width="500" height="500"/>
            </g>
            <g id="OBJECTS">
                
                    <radialGradient id="SVGID_1_" cx="250" cy="364.6665" r="88.327" gradientTransform="matrix(1 0 0 0.0897 0 292.6601)" gradientUnits="userSpaceOnUse">
                    <stop  offset="5.800000e-07" style={{stoColor:"#606060"}}/>
                    <stop  offset="0.9997" style={{stoColor:"#EAEDEE",stoOpacity:0}}/>
                </radialGradient>
                <ellipse style={{opacity:'0.3',fill:'url(#SVGID_1_)'}} cx="250" cy="325.368" rx="124.761" ry="10.991"/>
                <g>
                    <g>
                        <path fill="#003159" d="M229.89,279.525c-0.494-1.595-1.249-3.063-2.211-4.364c-2.702-3.654-7.029-5.978-11.807-5.977
                        ...
                        <path fill="#003159" d="M307.985,264.614c-1.085-0.885-2.292-1.618-3.594-2.166c-1.612-0.679-3.361-1.073-5.184-1.134
                        ...
                        <path fill="#003159" d="M175.766,189.285l-2.558-26.849c-1.24-13.018-12.233-22.8-25.055-22.8
                        ...
                        <path fill="#003159" d="M341.065,173.535l-1.326-13.911c-0.572-6.007-5.626-10.506-11.54-10.506
